...
<html>
    <head>
        <title>Writer Review Form</title>
...
<body>
    ...
    $query="select firstname,lastname from Documentwriters where writerid=$id";
    ...
    echo "</h1><br>
    <form action='document_display.php?id=$id' method='POST' >
        <div class='t1'>
